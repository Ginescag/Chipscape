...
sc05_init::
  ...
  pop de
  ld d, CMP_PHYSICS_H
  ld hl, sc05_playerR+8
  ld b, CMP_SIZE
  call memcpy


  ld  hl, sc05_entities_REST
  ld  b, (sc05_entities_REST_END - sc05_entities_REST) / (CMP_SIZE*3)
