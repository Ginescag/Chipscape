...
EXPORT Timer_LoadTiles, Timer_SetSecsHL, Timer_Init
EXPORT Timer_ComputeDigits, Timer_HUD_Init, Timer_HUD_Update, Timer_ISR
...
Timer_LoadTiles:
  ld de, DigitsTiles
  ld hl, $8000 + (DIGIT_TILE_BASE*16)
  ld bc, DigitsTilesEnd - DigitsTiles
  call Timer_CopyBytes
  ret
